...
namespace StellarisNameListGenerator.Models
{
    public class NameList : EntityBase
    {
        ...
        public void AddRange(NameList other)
        {
            ...
            GreatPeople.CreationDeities.AddRange(other.GreatPeople.CreationDeities);
            GreatPeople.DestructionDeities.AddRange(other.GreatPeople.DestructionDeities);
            GreatPeople.PeaceDeities.AddRange(other.GreatPeople.PeaceDeities);
            GreatPeople.WarDeities.AddRange(other.GreatPeople.WarDeities);
            GreatPeople.VictoryDeities.AddRange(other.GreatPeople.VictoryDeities);
            ...
            GreatPeople.SorrowDeities.AddRange(other.GreatPeople.SorrowDeities);
            ...
            GreatPeople.ProphecyDeities.AddRange(other.GreatPeople.ProphecyDeities);
            GreatPeople.JusticeDeities.AddRange(other.GreatPeople.JusticeDeities);
            GreatPeople.ProtectionDeities.AddRange(other.GreatPeople.ProtectionDeities);
            GreatPeople.PunishmentDeities.AddRange(other.GreatPeople.PunishmentDeities);
            GreatPeople.LoyaltyDeities.AddRange(other.GreatPeople.LoyaltyDeities);
            GreatPeople.DisloyaltyDeities.AddRange(other.GreatPeople.DisloyaltyDeities);
            ...
            GreatPeople.LoveDeities.AddRange(other.GreatPeople.LoveDeities);
            GreatPeople.KnowledgeDeities.AddRange(other.GreatPeople.KnowledgeDeities);
            ...
            GreatPeople.FortuneDeities.AddRange(other.GreatPeople.FortuneDeities);
            GreatPeople.SleepDeities.AddRange(other.GreatPeople.SleepDeities);
            GreatPeople.DarknessDeities.AddRange(other.GreatPeople.DarknessDeities);
            GreatPeople.LightDeities.AddRange(other.GreatPeople.LightDeities);
            ...
            GreatPeople.WarmthDeities.AddRange(other.GreatPeople.WarmthDeities);
            ...
            Stations.Outposts.AddRange(other.Stations.Outposts);
